  ...
  <body>
    ...
    <img
      ...
      <button class="schedule-page-get-schedule-button">
        ...
        />
        <span onclick="getGame(document.querySelector(`#franchise-select`).value, document.querySelector(`#date-select`).value, '96k2kff6f9rxmh33j80j95h0f95ku1j26jgoxs2h028j1i7gjk')" class="schedule-page-get-games-buttontext"><span>Get Games</span></span>
      </button>
